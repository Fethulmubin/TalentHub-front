...
export default function Admin() {
  return (
    <div className="p-6">
      ...
      {/* Promotional Section */}
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-2xl shadow-lg p-8 mb-6">
        <h2 className="text-2xl font-semibold mb-3">Welcome to TalentHub 🎉</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-md p-6 rounded-xl border hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
            <Briefcase className="w-6 h-6 text-blue-600" /> For Employers
          </h3>
        ...
        <div className="bg-white shadow-md p-6 rounded-xl border hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
            <Users className="w-6 h-6 text-purple-600" /> For Job Seekers
          </h3>
          <p className="text-gray-600 mb-4">
